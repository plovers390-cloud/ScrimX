...
class ScrimsEditor(ScrimsView):
    ...
    async def _add_buttons(self):
        ...
        self.add_item(SetName(self.ctx, "1"))
        self.add_item(RegChannel(self.ctx, "2"))
        self.add_item(SlotChannel(self.ctx, "3"))
        self.add_item(SetRole(self.ctx, "4"))
        self.add_item(SetMentions(self.ctx, "5"))
        self.add_item(TotalSlots(self.ctx, "6"))
        self.add_item(OpenTime(self.ctx, "7"))
        self.add_item(SetEmojis(self.ctx, "8"))
        self.add_item(PingRole(self.ctx, "9"))
        self.add_item(OpenRole(self.ctx, "10"))

        self.add_item(MultiReg(self.ctx, "11"))
        self.add_item(TeamCompulsion(self.ctx, "12"))
        self.add_item(DuplicateTeam(self.ctx, "13"))
        self.add_item(DeleteReject(self.ctx, "14"))
        self.add_item(DeleteLate(self.ctx, "15"))
        self.add_item(SlotlistStart(self.ctx, "16"))
        self.add_item(SetAutoclean(self.ctx, "17"))
        self.add_item(OpenDays(self.ctx, "18"))
        self.add_item(MinLines(self.ctx, "19"))
        self.add_item(DuplicateTags(self.ctx, "20"))
